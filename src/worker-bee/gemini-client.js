// warehouse:file
// responsibility: Language model API client aggregator - delegates to focused modules for key resolution, HTTP transport, JSON extraction, retry logic, and orchestration
// actor: worker_bee_infrastructure
// role: entry_point
// source_truth: implementation

const { callGemini, callGeminiJSON, DEFAULT_MODEL } = require("./gemini-modules/model-caller");
