...
// role: implementation
// source_truth: implementation
async function main(root, repoRoot, target, packet, rt, dryRun, json, packetFile) {
  ...
  // Live status ledger: written after every packet so a background run is observable while in flight
